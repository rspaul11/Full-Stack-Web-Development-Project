...
<% 
	...
	System.out.print("\n Admin/AdminViewUserResume3.jsp Called \n");
	...
	try{	
		...
		*/
		...
		while(rsCheckProject.next())
		{
			...
			String fetchProjectExp = "SELECT * FROM Student_Project_Exp WHERE stuemail = ?";
			PreparedStatement pstFetchedProjectExp = con.prepareStatement(fetchProjectExp);
			pstFetchedProjectExp.setString(1, stuemail);
...
<meta charset="ISO-8859-1">
	...
	<link rel="stylesheet" type="text/css" href="../../CSS/Admin/AdminViewUserResume3.css">
