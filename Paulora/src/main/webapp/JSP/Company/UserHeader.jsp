	...
	<section id="menu">
		<nav class="menu-container">
			...
			<ul>
				...
				<li><a href="../User/UserIndex.jsp" title="Home"><span class="material-icons"> home </span></a></li>

				<li class="discription"><a href=""><span class="material-icons"> description </span></a>
					<div class="dropdown-content">
						<a href="../User/ViewNewOpp.jsp">New Opportunities</a>
				...
				<li class="discription"><a href="#" title="Generate Resume"><span class="material-icons"> badge </span></a>
					<div class="dropdown-content">
						<a href="../User/UserResume.jsp" target="_blank">Simple Template</a>
						<a href="../User/UserResume2.jsp" target="_blank">Modern Template</a>
  						<a href="../User/UserResume3.jsp" target="_blank">Advanced Template</a>
  					</div>
				</li>
				
				<li><a href="../User/ViewQuizIndex.jsp" title="Practice Quiz"><span class="material-icons">quiz</span></a></li>
				
				<li><a href="../User/ViewCompanyIndex.jsp" title="Company Details"><span class="material-icons">business</span></a></li>
				
				<li><a href="../User/UserSettings.jsp" title="Settings"><span class="material-icons"> manage_accounts </span></a></li>
